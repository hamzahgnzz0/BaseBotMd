...
const expiredCheck = (whans, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            whans.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              whans.groupLeave(_dir[position].id)
